...
export const novantGallery: StudioGallery[] = [
  {
    ...
    images: [
      {
        src: "/case-studies/novant-health-aurora/1-novant-health-aurora-iconography-cover.png",
        alt: "Aurora icon system, cover",
        caption: "Aurora icon system — cover",
      },
      {
        src: "/case-studies/novant-health-aurora/2-iconography-process-c.png",
        alt: "Aurora icon system design process",
        caption: "Aurora icon system — design process",
      },
      {
        src: "/case-studies/novant-health-aurora/3-icon-research-board.png",
      ...
      {
        src: "/case-studies/novant-health-aurora/4-physician-finder-initial-wireframe.png",
        alt: "Physician Finder feature, initial wireframe flow",
        caption: "Physician Finder — initial wireframe flow",
      },
      {
        src: "/case-studies/novant-health-aurora/5-physician-finder-refined-flow.png",
